...
func _ready():
	...
	if linkst.saving_stats['g'] == 0:
		$Local.icon = ResourceLoader.load("res://Sprites/For_HScroll/DEUc.png")
		$Local.text = 'Deutsch'
		TranslationServer.set_locale('de')
		
		return
	elif linkst.saving_stats['g'] == 1:
		$Local.icon = ResourceLoader.load("res://Sprites/For_HScroll/RUSc.png")
		$Local.text = 'Русский'
		TranslationServer.set_locale('ru')
		
		return
	elif linkst.saving_stats['g'] == 2:
		$Local.icon = ResourceLoader.load("res://Sprites/For_HScroll/ENGc.png")
		$Local.text = 'English'
